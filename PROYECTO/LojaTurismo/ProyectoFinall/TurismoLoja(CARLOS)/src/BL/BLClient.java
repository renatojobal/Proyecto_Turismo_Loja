...
public class BLClient {
    ...
    public Client findClientIdentificationDB(String strCedula) throws ClassNotFoundException, SQLException 
    {
...
//  
    ...
    public boolean validateIdentification(String cedula) {
